...
const STEPS = [
  ...
  {
    title: "מאמנים את המודל על הסניפים שלכם",
    desc: "מתחברים לקופה ולהיסטוריית המכירות. כל סניף מאמן מודל משלו, מותאם לתפריט, למזג האוויר ולאירועים המקומיים שלו.",
  },
  {
    title: "מתחילים בכמה סניפים",
    desc: "עולים לאוויר בשלושה-ארבעה סניפים קודם, במקום שבו הרווח דולף הכי הרבה.",
  },
  {
    title: "פורסים לכל הרשת",
    desc: "ברגע שזה עובד, מרחיבים לכל הסניפים. כל אחד מאמן את המודל שלו, אותו פלייבוק בכל מקום.",
  },
];
