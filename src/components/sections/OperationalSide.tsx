...
const STEPS = [
  ...
  },
  {
    ...
    desc: "הזמנות יוצאות ישירות לספקים לפי התחזית, מסונכרנות עם Tabit ו-Restigo, כדי שהמדף לא יתרוקן באמצע משמרת ולא יתמלא בסחורה שתיזרק.",
  },
  {
    number: "03",
...
function OrdersMockup() {
  const rows = [
    ...
    { name: "לחמניות · 300 יח'", status: "אושר" },
